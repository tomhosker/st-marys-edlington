...
class Uploader {
    ...
    insertNewServiceTime(req, res) {
        ...
        const rawParams = [
            ...
            req.body.hasChildrensLiturgy,
            req.body.childrensLiturgyRemarks,
            req.body.remarks
        ];
        const query =
            "INSERT INTO "+tableName+" (weekday, hours, minutes, "+
                "location, service_type, day, month, year, " +
                "hasCildrensLiturgy, childrensLiturgyRemarks, remarks) " +
    ...
    insertNewNewsletter(req, res) {
        ...
        const query =
            "INSERT INTO "+tableName+" (week_beginning_day, "+
    ...
    runQueries(req, res, queries, tableName, index, errors) {
        ...
        client.query(queryString, params, (err, result) => {
            ...
            if (index === queries.length-1) {
                ...
                that.runQueries(req, res, queries, tableName, index+1, errors);
            }
        });
    }
}
